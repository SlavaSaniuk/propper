...
public class PropertiesTableView232 {

    private final GridPane propsTable; // GridPane layout;

    /**
     * Construct new {@link PropertiesTableView232} view with inner GridPane table.
     * @param aPropertiesTable - inner GridPane properties table.
     */
    public PropertiesTableView232(GridPane aPropertiesTable) {
     ...
     * Note: Columns creates via {@link PropertiesTableView232#titleColumn(String)} method.
     */
